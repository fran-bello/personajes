...
// Necesario para cerrar el browser después de auth
...
export default function LoginScreen() {
  ...
  const { login, loginWithGoogle, rememberMe, savedEmail } = useAuth();
  ...
  const handleLogin = async () => {
    ...
    const result = await login(email.trim(), password, rememberMeChecked);
      ...
      >
        ...
        >
          <View style={styles.content}>
            ...
            <Card style={styles.formCard}>
              ...
              <View style={styles.rememberMeRow}>
                ...
                <Switch
                  ...
                  thumbColor={rememberMeChecked ? colors.text : colors.textMuted}
                />
              </View>
            ...
            >
              <Text style={styles.localGameText}>
                ¿Quieres jugar sin cuenta?{' '}
                <Text style={styles.localGameLink}>Juego Local</Text>
              </Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
